  ...
  return (
    <div className="space-y-10">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-display font-black text-brand-dark tracking-tighter mb-2">Orders</h1>
          <p className="text-gray-400 font-bold text-sm uppercase tracking-widest">Manage and track all customer orders</p>
        </div>
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2 text-xs font-black text-gray-400 uppercase tracking-widest bg-white px-6 py-3 rounded-2xl border border-gray-100 shadow-sm">
      ...
      <div className="bg-white p-10 rounded-[3rem] shadow-sm border border-gray-100">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] border-b border-gray-50">
                ...
                <th className="pb-6 px-4">Link</th>
                <th className="pb-6 px-4 text-center">Quantity</th>
            ...
            <tbody className="divide-y divide-gray-50">
              {orders.map((order, idx) => (
                ...
                >
                  <td className="py-6 px-4 text-sm font-black text-brand-dark group-hover:text-brand-orange transition-colors">{order.id}</td>
                  ...
                  <td className="py-6 px-4 text-sm text-brand-orange font-bold truncate max-w-[150px] hover:underline transition-all underline-offset-4 cursor-pointer">{order.link}</td>
                  <td className="py-6 px-4 text-sm font-black text-brand-dark text-center">{order.quantity}</td>
                  <td className="py-6 px-4 text-sm font-black text-brand-dark">{order.charge}</td>
                  <td className="py-6 px-4">
                    <span className={`inline-flex items-center px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest ${statusStyles[order.status as keyof typeof statusStyles]}`}>
                      {order.status}
                    </span>
                  </td>
                  <td className="py-6 px-4 text-xs font-bold text-gray-400">{order.payment}</td>
                  ...
                  <td className="py-6 px-4 text-right">
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <button className="w-9 h-9 rounded-xl bg-gray-50 text-gray-400 hover:text-blue-500 hover:bg-blue-50 transition-all flex items-center justify-center group/btn">
                        <FontAwesomeIcon icon={faEdit} className="group-hover/btn:scale-110 transition-transform" />
                      </button>
                      <button className="w-9 h-9 rounded-xl bg-gray-50 text-gray-400 hover:text-emerald-500 hover:bg-emerald-50 transition-all flex items-center justify-center group/btn">
                      ...
                      <button className="w-9 h-9 rounded-xl bg-gray-50 text-gray-400 hover:text-rose-500 hover:bg-rose-50 transition-all flex items-center justify-center group/btn">
                        <FontAwesomeIcon icon={faTimesCircle} className="group-hover/btn:scale-110 transition-transform" />
                      </button>
                    </div>
                  </td>
                </motion.tr>
        ...
        <div className="mt-10 flex items-center justify-between pt-10 border-t border-gray-50">
          <div className="text-xs font-black text-gray-400 uppercase tracking-widest">
            Showing <span className="text-brand-dark">1-5</span> of <span className="text-brand-dark">84,921</span> orders
          </div>
          <div className="flex items-center space-x-2">
            <button className="px-6 py-3 rounded-xl bg-gray-50 text-gray-400 font-black uppercase tracking-widest text-[10px] hover:bg-gray-100 transition-all">Previous</button>
            <button className="w-10 h-10 rounded-xl bg-brand-orange text-white font-black text-[10px] shadow-lg shadow-brand-orange/20">1</button>
            <button className="w-10 h-10 rounded-xl bg-gray-50 text-gray-400 font-black text-[10px] hover:bg-gray-100">2</button>
            <button className="w-10 h-10 rounded-xl bg-gray-50 text-gray-400 font-black text-[10px] hover:bg-gray-100">3</button>
            <button className="px-6 py-3 rounded-xl bg-gray-50 text-gray-400 font-black uppercase tracking-widest text-[10px] hover:bg-gray-100 transition-all">Next</button>
          </div>
        </div>
      </div>
    </div>
